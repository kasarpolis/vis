...
Group.prototype._calculateGroupSizeAndPosition = function() {
  var offsetTop, offsetLeft, offsetWidth;
  fastdom.measure(() => {
    offsetTop = this.dom.foreground.offsetTop
    offsetLeft = this.dom.foreground.offsetLeft
    offsetWidth = this.dom.foreground.offsetWidth
  });
  fastdom.mutate(() => {
    this.top = offsetTop;
...
Group.prototype.redraw = function(range, margin, forceRestack, returnQueue) {
  ...
  var queue = [
    ...
    (function() {
      fastdom.measure(() => {
        labelWidth = this.dom.inner.clientWidth;
        labelHeight = this.dom.inner.clientHeight;
        offsetTop = this.dom.foreground.offsetTop;
        offsetLeft = this.dom.foreground.offsetLeft;
        offsetWidth = this.dom.foreground.offsetWidth;
      });
