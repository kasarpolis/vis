...
Group.prototype._getGroupWidthAndPosition  = function() { 
  return {
...
Group.prototype._setGroupWidthAndPosition = function({width, top, left}) {
...
Group.prototype.redraw = function(range, margin, forceRestack, returnQueue) {
  ...
  var queue = [
    ...
    // get actual width  and position
    () => {
      [ width, top, left ] = this._getGroupWidthAndPosition();
    },

    // set actual width  and position
    () => {
      this._setGroupWidthAndPosition({width, top, left});
    },
