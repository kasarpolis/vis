...
Group.prototype._getGroupDomProperties = function() {
  return [
    this.dom.foreground.offsetTop,
    this.dom.foreground.offsetLeft,
    this.dom.foreground.offsetWidth,
...
Group.prototype._didResize = function(resized, height, labelWidth, labelHeight) {
...
Group.prototype._setDomGroupHeight = function(height) {
...
Group.prototype.redraw = function(range, margin, forceRestack, returnQueue) {
  ...
  var queue = [
    ...
    () => {
      [ top, left, width, labelWidth, labelHeight ] = this._getGroupDomProperties.bind(this)()
    },
    ...
    // check if resized
    () => {
      resized = this._didResize.bind(this)(resized, height, labelWidth, labelHeight)
    },

    // apply group height
    () => {
      this._setDomGroupHeight.bind(this)(height)
    },
