...
RangeItem.prototype.redraw = function() {
  ...
  if (this.dirty) {
    ...
    var contentOffsetWidth =  this.dom.content.offsetWidth;
    var boxOffsetWidth =  this.dom.box.offsetWidth;
    
    this.dom.content.style.maxWidth = 'none';
    this.props.content.width = contentOffsetWidth;
    this.height = boxOffsetWidth;
