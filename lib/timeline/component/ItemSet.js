...
ItemSet.prototype.redraw = function() {
  ...
  var changedStackOption = options.stack != this.lastStackOption
  var changedStackSubgroupsOption = options.stackSubgroups != this.lastStackSubgroupsOption
  var forceRestack = (zoomed || scrolled || changedStackOption || changedStackSubgroupsOption);
  this.lastVisibleInterval = visibleInterval;
  this.lastRangeStart = range.start;
  this.lastStackOption = options.stack;
  this.lastStackSubgroupsOption = options.stackSubgroups;
