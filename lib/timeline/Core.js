...
Core.prototype._redraw = function() {
  ...
  props.border.left   = Math.ceil((dom.centerContainer.offsetWidth - dom.centerContainer.clientWidth) / 2);
...
Core.prototype._startAutoResize = function () {
  ...
  this._onResize = function() {
    ...
    if (me.dom.root) {
      ...
      if (Math.abs(me.dom.root.offsetWidth - me.props.lastWidth)  > 1 ||
      (Math.abs(me.dom.root.offsetHeight - me.props.lastHeight) > 1 )) {
