...
Core.prototype._redraw = function() {
  ...
  var isWidthZero;
  fastdom.measure(() => {
    isWidthZero = dom.root.offsetWidth == 0;
  });

  if (!dom || !dom.container || isWidthZero) return; // when destroyed, or invisible
  ...
  var leftContainerWidth = dom.leftContainer.clientWidth;
  var rightContainerWidth = dom.rightContainer.clientWidth;
  ...
  if (options.verticalScroll) {
    if (options.rtl) {
      props.left.width = leftContainerWidth || -props.border.left;
      props.right.width = rightContainerWidth + props.scrollbarWidth || -props.border.right;
    } else {
      props.left.width = leftContainerWidth + props.scrollbarWidth || -props.border.left;
      props.right.width = rightContainerWidth || -props.border.right;
    }
  } else {
    props.left.width = leftContainerWidth  || -props.border.left;
    props.right.width = rightContainerWidth || -props.border.right;
